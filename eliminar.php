        ...
        <div class="row">
                ...
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="txtNombreProducto" placeholder="Sabritas" disabled="true">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="txtDescripcion" placeholder="Papas fritas" disabled="true">
                        ...
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control" id="txtStock" placeholder="50" disabled="true">
                            <label for="txtStock">
                        ...
                        <div class="form-floating mb-3">
                            <input class="form-control" list="datalistOptions" id="txtCategoria" placeholder="Categoria" disabled="true">
                        ...
                        <a href="#" class="btn btn-primary btn-danger">Eliminar</a>
                    </div>
                </div>
                </br>
            </div>
            <div class="col-6 offset-1">
                ...
                <p class="title">
                    ...
                    ¿Descontinuarás este producto enserio?
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-exclamation-circle-fill" viewBox="0 0 16 16" style="color: #39b54a;">
                        <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z" />
                    </svg>
                </p>
                <p class="instructions">Revisa que el producto que estás a punto de eliminar sea el que deseas realmente eliminar

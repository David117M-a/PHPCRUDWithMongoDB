        ...
        <div class="row">
            <div class="col-6">
                ...
                <p class="title">
                    ...
                    Registra nuevos productos fácilmente llenando la tarjeta.
                ...
                <p class="instructions">Recuerda que la claridad de los datos son importantes para que tu
            ...
            <div class="col-5 offset-1">
                ...
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        ...
                        <button type="submit" onclick="insertOne()" class="btn btn-primary">Guardar</button>
                    </div>
                </div>
                </br>
            </div>

...
<body class="body">
<div class="row header" style="background-color: #072046;">
            <div class="col-12">
                <p style="font-size: 3vw;">StoreManager</p>
            </div>
        </div>
                ...
                <div class="card text-center mt-5 mb-5">
                    ...
                    <div class="card-body">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="txtUser" placeholder="User11234">
                            <label for="txtUser">
                        ...
                        <button type="submit" onclick="verifyLogin()" class="btn btn-primary">Iniciar sesión</button>
                    </div>
                    <div class="card-footer text-muted">
                        Ingresa tu nombre de usuario y contraseña: si no cuentas con una cuenta <a href="./register.php">registrate aquí.</a>
                    </div>
                </div>
            </div>
        </div>
